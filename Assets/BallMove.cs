...
public class BallMove : MonoBehaviour
{
    ...
    UnityEngine.Rendering.Universal.Light2D ballLight;
    ...
    void Start()
    {
        ...
        ballLight = gameObject.GetComponent<UnityEngine.Rendering.Universal.Light2D>();
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        else if (collision.gameObject.tag == "Paddle")
        {
            ...
            lt = collision.gameObject.GetComponent<UnityEngine.Rendering.Universal.Light2D>();
    ...
    IEnumerator LightIntensity(UnityEngine.Rendering.Universal.Light2D lightToFade)
    {
